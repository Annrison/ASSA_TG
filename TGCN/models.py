...
class Model(object):
    ...
    def build(self):
        ...
        with tf.variable_scope(self.name): # todo
            self._build()
        ...
        # tf.disable_v2_behavior() # todo #added
...
class GCN(Model):
    def __init__(self, placeholders, input_dim, **kwargs):
        ...
        self.optimizer = tf.train.AdamOptimizer(learning_rate=FLAGS.learning_rate) # todo
